...
'web.checkout.cardinal.songbird_error': ['message'],
'web.checkout.rokt.load_failure.counter': ['value', 'timestamp'],
'web.myaccount.fanwallet.client_token_expiration.counter': ['value', 'timestamp'],
'web.myaccount.fanwallet.initialization_failed.counter': ['value', 'timestamp']
},
